...
if menu == "Tambah":
    ...
    data = read_siswa()
    if data:
        nims = [row[1] for row in data]  # ambil NIM dari hasil read_siswa
        ...
        angkatan_baru = st.number_input("Angkatan baru", min_value=2020, max_value=2030, step=1, value=siswa[3])
